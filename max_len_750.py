...
Original file is located at
    https://colab.research.google.com/drive/1HcUUIBdto1GnT5IwXl80iCRpbWnS06IG
"""
...
embedding_layer = Embedding(vocab_size, 300, weights=[embedding_matrix_glove], input_length=750, trainable=False)
...
embedding_layer_ftext = Embedding(vocab_size, 300, weights=[embedding_matrix_ft], input_length=750, trainable=False)
